...
namespace Marx.Utilities {
    ...
    /// <summary>
    /// A serializable struct designed to encapsulate a System.Guid in Unity's serialization system, providing
    /// functionalities to compare, validate, and serialize GUID values.
    /// </summary>
    [Serializable]
    public struct SGuid : ISerializationCallbackReceiver, IComparable<SGuid>, IEquatable<SGuid>, IComparable<Guid>,
        IEquatable<Guid>, IEqualityComparer<SGuid> {
